...
4. The user enters the required rocket-design information in a manual form.
...
- Design name
- Measurement system or clearly identified units
- Total rocket length
- Main body diameter
- Main body length
...
- **Static margin less than or equal to 0 calibers:** critical warning or invalid stability condition
- **Static margin greater than 0 but less than 1 caliber:** warning
- **Static margin from 1 to 2 calibers:** passed or within the intended range
- **Static margin greater than 2 calibers:** informational warning requesting further review
...
> **Warning - Static margin below the intended range:** The static margin falls below 1 caliber. Review the center-of-gravity position, fin geometry, and mass distribution before continuing.
...
> The static margin is below 1 caliber. Review the center-of-gravity position, fin geometry, or mass distribution.
